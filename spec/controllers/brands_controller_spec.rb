  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created brand" do
        post :create, {:brand => valid_attributes}, valid_session
        response.should redirect_to(Brand.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved brand as @brand" do
        ...
        post :create, {:brand => {}}, valid_session
        assigns(:brand).should be_a_new(Brand)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested brand" do
        ...
        put :update, {:id => brand.to_param, :brand => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the brand" do
        brand = Brand.create! valid_attributes
        put :update, {:id => brand.to_param, :brand => valid_attributes}, valid_session
        response.should redirect_to(brand)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the brand as @brand" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Brand.any_instance.stub(:save).and_return(false)
        put :update, {:id => brand.to_param, :brand => {}}, valid_session
        assigns(:brand).should eq(brand)
      end
